...
if(isset($_GET['uid'])){
    $udata=$_GET['uid'];
    $nquery = "SELECT * FROM users where uid='$udata'";
...
if(isset($_POST['submit'])){
    ...
    $query = "UPDATE users SET username='$name', email='$email', phone='$phone',gender='$gender', country='$country', state='$state', city='$city',postal='$postal',dob='$dob',descr='$desc', martial='$mart',social='$sm1', social2='$sm2', profession='$prof', uprofile='$folder' where uid='$udata'";
    $result = mysqli_query($conn, $query);
        if($result){
            $date= "INSERT INTO userupdate(uid) VALUES('$uid')";
