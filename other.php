...
<body>
 ...
 <div id="accordion">
  ...
  <div>
    ...
    <p>
    <ul>
      <li>How many post is limited for a user ?<p>Any users can create as much post as they can. A single user has no restriction in creating a post in the website if they are registered members.</p></li>
      <li>Can same post be created again ?</li>
      <li>How  long the post will remain in the platform ?</li>
      <li>Is all the post details  visible to public ?</li>
      <li>Can I add images with my post ?</li>
      <li>Can I provide any link in my post ?</li>
    </ul>
    </p>
  </div>
