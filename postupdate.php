...
$sql = "UPDATE userpost SET userid='$id', images='$folder', price='$price', street='$area', ward='$wd', city='$ct', district='$dist', states='$st', country='$ctry', details='$info' where pid='$pid'";
        ...
        <div class="inner">
            <form method="POST" name="myForm" enctype="multipart/form-data" onsubmit="return validateForm()"
                ...
                <div class="text">
                    ...
                    <textarea name="information" id="text" cols="30" rows="10" maxlength="1000" value=<?php echo $uinfo;
                        ?>></textarea>
                </div>
                <div class="below">
